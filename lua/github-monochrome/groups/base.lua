...
function M.get(c, opts)
  ...
  return {
    ...
    FloatBorder                 = { fg = c.border_highlight, bg = c.bg },
    FloatTitle                  = { fg = c.border_highlight, bg = c.bg },
    Pmenu                       = { bg = c.bg_popup, fg = c.fg },
    PmenuMatch                  = { bg = c.bg_popup, fg = c.magenta },
    PmenuSel                    = { bg = util.blend_bg(c.fg_gutter, 0.5) },
    PmenuMatchSel               = { bg = util.blend_bg(c.fg_gutter, 0.5), fg = c.magenta },
