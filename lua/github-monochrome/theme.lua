...
function M.setup(opts)
  ...
  local colors = require("github-monochrome.colors").setup(opts)
  local groups = require("github-monochrome.groups").setup(colors, opts)
  ...
  vim.g.colors_name = "github-monochrome-" .. opts.style
